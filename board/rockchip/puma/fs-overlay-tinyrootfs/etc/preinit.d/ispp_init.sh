...
#enable scal2
media-ctl -d /dev/media1 -l '"rkispp-subdev":2->"rkispp_scale2":0[0]'
...
#v4l2-ctl -d /dev/video16  --set-fmt-video=width=1280,height=720,pixelformat=NV12 --stream-mmap=4 --stream-count=10 --stream-poll &
