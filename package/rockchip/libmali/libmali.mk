...
else ifneq ($(BR2_PACKAGE_RK312X)$(BR2_PACKAGE_RK3128H),)
...
# px3se/312x not support opencl
ifeq ($(BR2_PACKAGE_PX3SE)$(BR2_PACKAGE_RK312X)$(BR2_PACKAGE_LIBMALI_WITHOUT_CL),)
