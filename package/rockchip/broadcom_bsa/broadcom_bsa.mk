...
define BROADCOM_BSA_INSTALL_TARGET_CMDS
	...
	sed -i 's/ttyS./$(BT_TTY_DEV)/g' $(TARGET_DIR)/usr/bin/bsa_bt_source.sh
	sed -i 's/ttyS./$(BT_TTY_DEV)/g' $(TARGET_DIR)/usr/bin/bsa_bt_sink.sh
	sed -i 's/ttyS./$(BT_TTY_DEV)/g' $(TARGET_DIR)/usr/bin/bsa_bt_hfp.sh
	sed -i 's/ttyS./$(BT_TTY_DEV)/g' $(TARGET_DIR)/usr/bin/bsa_ble_wifi_introducer.sh
