ifeq ($(BR2_PACKAGE_ROCKCHIP_SANITIZER),y)
...
define ADDRESS_SANITIZER_INSTALL_TARGET_CMDS
	# $(INSTALL) -D -m 0755 $(STAGING_DIR)/lib/libasan.so $(TARGET_DIR)/lib/
	# $(INSTALL) -D -m 0755 $(STAGING_DIR)/lib/libasan.so.5 $(TARGET_DIR)/lib/
