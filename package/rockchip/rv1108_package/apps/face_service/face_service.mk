...
ifeq ($(BR2_PACKAGE_RKFACE_DETECTION),y)
    ...
    FACE_SERVICE_CONF_OPTS += -DDOWNSCALE_WIDTH=$(BR2_PACKAGE_FACE_SERVICE_DETECT_WIDTH)
    FACE_SERVICE_CONF_OPTS += -DDOWNSCALE_HEIGHT=$(BR2_PACKAGE_FACE_SERVICE_DETECT_HEIGHT)
endif
...
ifeq ($(BR2_PACKAGE_FACE_SERVICE_RKLIVING_DETECTION),y)
    FACE_SERVICE_DEPENDENCIES += rkface
...
ifeq ($(BR2_PACKAGE_FACE_SERVICE_ENCODE_H264),y)
    FACE_SERVICE_DEPENDENCIES += rkmedia
    FACE_SERVICE_CONF_OPTS += -DUSE_H264_ENCODER=1
endif

ifeq ($(BR2_PACKAGE_FACE_SERVICE_3D_LIVE_DETECTION),y)
    FACE_SERVICE_CONF_OPTS += -DUSE_3D_LIVE_DETECTION=1
    FACE_SERVICE_CONF_OPTS += -DDEPTH_WIDTH=$(BR2_PACKAGE_FACE_SERVICE_DEPTH_WIDTH)
    FACE_SERVICE_CONF_OPTS += -DDEPTH_HEIGHT=$(BR2_PACKAGE_FACE_SERVICE_DEPTH_HEIGHT)
endif
...
FACE_SERVICE_CONF_OPTS += \
    -DDISPLAY_RESOLUTION=$(call qstrip,$(BR2_RV1108_LCD_RESOLUTION)) \
    -DMAIN_APP_PRE_FACE_ROTATE=$(call qstrip,$(BR2_PACKAGE_FACE_SERVICE_PRE_FACE_ROTATE)) \
    -DMAX_FEATURE_OF_USER=$(BR2_PACKAGE_FACE_SERVICE_MAX_FEATURE_OF_USER) \
    -DBOARD_VERSION=$(call qstrip,$(BR2_RV1108_BOARD_VERSION))
