...
ifeq ($(BR2_PACKAGE_DEVICE_MANAGER_STORAGEDEVICE),y)
    DEVICE_MANAGER_CONF_OPTS += -DENABLE_STORAGEDEVICE=1
endif

ifeq ($(BR2_PACKAGE_DEVICE_MANAGER_WLAN),y)
    DEVICE_MANAGER_CONF_OPTS += -DENABLE_WLAN=1
endif
