RV1108_FIRMWARE_SITE = package/rockchip/rv1108_firmware/nothing
RV1108_FIRMWARE_SITE_METHOD = local
...
kernel:
	...
	make -C $(RV_KERNEL_DIR) ARCH=$(RK_ARCH) rv1108-$(RK_TARGET_BOARD_VERSION)_defconfig
...
define RV1108_FIRMWARE_BUILD_CMDS
endef
